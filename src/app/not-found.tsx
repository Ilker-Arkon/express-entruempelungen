...
export default function NotFound() {
  return (
    <main className="flex-1 flex items-center justify-center min-h-[70vh] bg-zinc-50">
      <div className="container mx-auto px-6 py-24 text-center max-w-2xl">
        ...
        <p className="text-lg text-gray-600 mb-10 font-body leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          ...
          <Link
            href="/#leistungen"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border border-zinc-200 text-zinc-700 rounded-full font-bold hover:bg-zinc-100 transition-colors"
          >
