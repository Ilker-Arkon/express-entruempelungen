...
const defaultFAQs = [
  { question: "Wie erhalte ich ein Angebot?", answer: "Ganz einfach: Rufen Sie uns an, schreiben Sie uns per WhatsApp oder nutzen Sie unser Kontaktformular. Wir vereinbaren einen kostenlosen Besichtigungstermin vor Ort – danach erhalten Sie ein unverbindliches Angebot. Alles wird persönlich mit Ihnen besprochen." },
  { question: "Wie läuft eine Entrümpelung ab?", answer: "Der Ablauf ist für Sie völlig stressfrei: Nach Ihrer Anfrage vereinbaren wir einen kostenlosen Besichtigungstermin. Am Einsatztag räumt unser Team die vereinbarten Bereiche schnell und diskret. Zum Schluss übergeben wir Ihnen alle Räume besenrein. Sie müssen während der Arbeiten nicht zwingend vor Ort sein." },
  { question: "Sind Sie für eventuelle Schäden versichert?", answer: "Selbstverständlich. Unser Unternehmen ist umfassend betriebshaftpflichtversichert. Obwohl unser eingespieltes Team extrem vorsichtig arbeitet, sind Sie im unwahrscheinlichen Fall eines Schadens vollständig abgesichert." },
  { question: "Können Sie auch kurzfristig oder im Notfall tätig sein?", answer: "Ja, wir wissen, dass es oft schnell gehen muss – sei es durch einen Umzug, einen Todesfall oder eine Kündigung. Wir halten in unserer Terminplanung immer Kapazitäten für dringende Fälle frei und können oft sehr kurzfristig mit der Räumung beginnen." },
  { question: "Was passiert mit den entrümpelten Dingen?", answer: "Nachhaltigkeit ist uns wichtig. Gut erhaltene Gegenstände spenden wir an soziale Einrichtungen. Der restliche Abfall wird von uns fachgerecht nach Materialien (Holz, Metall, Bauschutt, Restmüll) sortiert und bei zertifizierten regionalen Recyclinghöfen umweltfreundlich entsorgt." },
  ...
  { question: "Räumen Sie auch extreme Härtefälle oder Messie-Wohnungen?", answer: "Ja, unser Team ist für jede Herausforderung geschult. Wir führen Messie-Entrümpelungen absolut diskret, respektvoll und professionell durch." },
