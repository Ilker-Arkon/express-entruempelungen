...
const defaultFAQs = [
  { question: "Was kostet eine Entrümpelung?", answer: "Die Kosten hängen von der Größe der Immobilie, dem Füllgrad und der Art der zu entsorgenden Gegenstände ab. Nutzen Sie gerne unseren Online-Kalkulator für eine erste unverbindliche Preisschätzung. Nach einer kostenlosen Besichtigung vor Ort erhalten Sie von uns ein transparentes Festpreisangebot – garantiert ohne versteckte Kosten." },
