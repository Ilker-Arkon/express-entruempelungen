...
export function TeamBlock({ title = "Unser Team" }: TeamProps) {
  return (
    <section id="team" className="py-24 bg-white dark:bg-[#1A1A2E]">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 font-body text-lg leading-relaxed mb-6">
              Seit über 10 Jahren sind wir Ihr verlässlicher Partner für schnelle, diskrete und saubere Entrümpelungen. Als familiengeführtes Unternehmen wissen wir, dass eine Haushaltsauflösung oft mehr ist als nur Möbel zu bewegen – es geht um Vertrauen.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 mt-8">
              <div className="flex items-center gap-3 bg-gray-50 dark:bg-[var(--dark-secondary)] px-4 py-3 rounded-xl border border-gray-100 dark:border-zinc-800">
                <Shield className="text-[var(--primary)] w-6 h-6" />
                <span className="font-semibold text-gray-900 dark:text-white">Betriebshaftpflicht</span>
              </div>
              <div className="flex items-center gap-3 bg-gray-50 dark:bg-[var(--dark-secondary)] px-4 py-3 rounded-xl border border-gray-100 dark:border-zinc-800">
                <Award className="text-[var(--primary)] w-6 h-6" />
                <span className="font-semibold text-gray-900 dark:text-white">IHK Zertifiziert</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-body font-medium leading-relaxed mb-6 relative z-10">
              Mein Wort an Sie: Wir verlassen keinen Einsatzort, bevor Sie nicht 100% zufrieden sind. Ihr Vertrauen ist unser höchstes Gut.
            </p>
        ...
        <div className="text-center mb-12">
          <h3 className="text-2xl font-bold font-heading text-gray-900 dark:text-white">{title}</h3>
        </div>
